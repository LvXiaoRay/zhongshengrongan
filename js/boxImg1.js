 ...
 */
var len = $("img[modal='zoomImg1']").length;
var arrPic = new Array(); //定义一个数组


$("img[modal='zoomImg1']").each(function () {
    $(this).on("click", function () {
        for (var i = 0; i < len; i++) {
            arrPic[i] = $("img[modal='zoomImg1']").eq(i).prop("src"); //将所有img路径存储到数组中
        }
        //给body添加弹出层的html
        $("body").append("<div class=\"mask-layer\">" +
            ...
            "           <button class=\"mask-prev btn-default-styles\" style=\"float: left;display: none\">上一张</button>" +
            ...
            "           <button class=\"mask-next btn-default-styles\" style=\"float: right;display: none\">下一张</button>" +
            "       </div>" +
