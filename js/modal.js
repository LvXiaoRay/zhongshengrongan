!function (f) {
    ...
    n.prototype = {
        constructor: n, toggle: function () {
            ...
            this.isShown && !e.isDefaultPrevented() && (this.isShown = !1, f("body").removeClass("modal-open"),
    ...
    f.fn.modal = function (e) {
        return this.each(function () {
            var g = f(this), h = g.data("modal"),
                p = f.extend({}, f.fn.modal.defaults, g.data(), "object" == typeof e && e);
            h || g.data("modal", h = new n(this, p));
            "string" == typeof e ? h[e]() : p.show && h.show()
        })
    };
    f.fn.modal.defaults = {backdrop: !0, keyboard: !0, show: !0};
    f.fn.modal.Constructor = n;
    f(function () {
        f("body").on("click.modal.data-api", '[data-toggle="modal"]', function (e) {
            var g = f(this), h = g.attr("href"), p = f(g.attr("data-target") || h && h.replace(/.*(?=#[^\s]+$)/, "")),
                h = p.data("modal") ?
                    "toggle" : f.extend({remote: !/#/.test(h) && h}, p.data(), g.data());
            e.preventDefault();
